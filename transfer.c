...
float sigma_KBH = 1.666; // værdien for en inkubatiostid på 6 dage (sigma = 1/inkubationstid)

float days = 1.0;
float N_AAL = 121888;
float N_KBH = 667149;

// t står bare for transferrate, ved ikke lige hvad jeg skal sætte den til, så sætter den på 0.1%, da forskellen er alt for meget på 1%
float t = 0.001;
                   ...
                   float S_KBH_start, float E_KBH_start, float I_KBH_start, float R_KBH_start) // kun til windows indtilvidere
{
    ...
    for (int n = 0; n < 150; n++)
    {
        ...
        // vi regner her ud hvor mange der rejser ud af hver by.
        // t = 0.001 betyder fx at 0.1% af S, E, I og R rejser.
        ...
        // differentialligninger med transfer - AALBORG
        ...
        // differentialligninger med transfer - KØBENHAVN
